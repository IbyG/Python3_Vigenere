...
-i followed by filename to read and ecnrypt
-id followed by a filename to read and decrypt 
-o followed by a filename to output the text into""")
    ...
    if("-i" in userOptions):
        ...
        try: 
            ...
            print("no argument (filename) given for -i")
            exit(1)

        #encrypting the text
        encrypt(txt,key,alphabet)

    #textfile to read and decrypt
    if("-id" in userOptions):
        ...
        try: 
            ...
            print("no argument (filename) given for -id")
            exit(1)
    ...
    #storing the latest text into a text file
    if("-o" in userOptions):
        #getting position of the file name
        ...
        if(latestText != " "):
            ...
            try: 
                filename = userOptions[x] 
            except IndexError: 
                #autogenerated file name if nothing was given 
                filename = "encrypt-File-" + str(r1)

            SaveToFile(latestText,filename)
